...
final products = <Product>[
  ...
  Product(
      ...
      price: 18),
  Product(
      image: 'hot_coffee/hot_coffee1.png',
      category: categories[0],
      name: 'Caffe Americano',
      price: 18),
  Product(
      image: 'hot_coffee/hot_coffee3.png',
      name: 'Mistletoe Coffee',
      category: categories[0],
      price: 18),
  Product(
      image: 'hot_coffee/hot_coffee2.png',
      name: 'Cappuccino',
      category: categories[0],
      price: 18),
  Product(
      image: 'hot_coffee/hot_coffee4.png',
      category: categories[0],
      name: 'Featured Medium Roast - Pike Place Roast',
      price: 18),
  Product(
      image: 'hot_coffee/hot_coffee5.png',
      category: categories[0],
      name: 'Honey Almondmilk Flat White',
      price: 18),
  Product(
      category: categories[2],
      image: 'hot_teas/hot teas1.png',
      name: 'Chai Tea Latte',
      price: 18),
  Product(
      image: 'hot_teas/hot teas2.png',
      category: categories[2],
      name: 'Chai Tea',
      price: 18),
  Product(
      image: 'hot_teas/hot teas3.png',
      category: categories[2],
      name: "Emperor's Clouds & Mist",
      price: 18),
  Product(
      image: 'hot_teas/hot teas4.png',
      category: categories[2],
      name: 'Honey Citrus Mint Tea',
      price: 18),
  Product(
      image: 'hot_teas/hot teas5.png',
      category: categories[2],
